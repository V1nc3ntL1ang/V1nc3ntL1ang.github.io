...
<div class="edu-item">
  ...
  <div class="edu-content">
    ...
    <div class="edu-degree">Berkeley Global Access Program</div>
    <div class="edu-date">Jan. 2025 - May. 2025</div>
    <div class="edu-desc">
      Completed courses:  CS168 (Introduction to the Internet), CS186 (Introduction to Database Systems), CS188 (Introduction to Artificial Intelligence)
    </div>
  </div>
</div>
